...
export const LogIn = () => {
  ...
  if (unauthorized) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-dark p-5">
        <div className="text-center max-w-lg">
          ...
          <button
            onClick={() => navigate("/")}
            className="px-6 py-2.5 bg-amber text-black rounded cursor-pointer font-600 text-sm"
          >
            Return to Home
          </button>
          <p className="text-xs text-tan/60 mt-5">
      ...
      <div className="login-left">
        ...
        <div className={`login-form-inner ${mounted ? "mounted" : ""}`}>
          ...
          <form onSubmit={handleSubmit} className="form-body">
            ...
            {/* Form-level error */}
            {errors.form && (
              <div className="p-3 mb-4 bg-red-900 bg-opacity-10 border border-red-900 border-opacity-30 rounded text-red-600 text-xs font-inter">
                {errors.form}
              </div>
            )}
